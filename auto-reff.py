...
def show_branding_box():
    """this script is completely free to use must support our channel"""
    branding_text = f"""
...
def main():
    try: 
        show_branding_box()  # Show branding box at the start
        while True:
            # Generate wallet
